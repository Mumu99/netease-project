...
// 获取值得买瀑布流的数据
export const reqGoodBuyMore = (page, size) => Goodajax.get(`/find/recAuto.json?page=${page}&size=${size}`)
// 获取搜索界面初始化数据
export const reqSearchInit = () => Searchajax.post('/init.json')
// 搜索列表数据
export const reqSearchList = (searObj) => Searchajax.get(`/search.json?${searObj}`)